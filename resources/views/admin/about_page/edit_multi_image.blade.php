...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Update Scroll Image</h4> <br><br>
            ...
            <form method="post" action="{{ route('update.multi.image') }}" enctype="multipart/form-data">
             ...
             <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">About Scroll Image </label>
                <div class="col-sm-10">
  ...
  <img id="showImage" class="rounded avatar-lg" src="{{ asset($multiImage->multi_image)  }}" alt="Card image cap">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Scroll Image">
            </form>
