...
<div class="row mb-3">
    <label for="example-text-input" class="col-sm-2 col-form-label">Tittle</label>
    <div class="col-sm-10">
        <input name="tittle" class="form-control" type="text" value="{{ $aboutpage->tittle }}"  id="example-text-input">
    </div>
</div>
<!-- end row -->

  <div class="row mb-3">
    <label for="example-text-input" class="col-sm-2 col-form-label">Short Tittle </label>
    <div class="col-sm-10">
        <input name="short_tittle" class="form-control" type="text" value="{{ $aboutpage->short_tittle }}"  id="example-text-input">
    </div>
</div>
<!-- end row -->
